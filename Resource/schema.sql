...
create table physical_chemical_inspection(
    ...
    antiHCVantibody_date Date,
    hcv_rna varchar(20),
    hcv_rna_date Date,
    protein varchar(20),
    protein_date Date,
    red_blood_cell varchar(20),
    red_blood_cell_date Date,
    white_blood_cell varchar(20),
    white_blood_cell_date Date,
