...
angular.module('biologicalSamples', [])
    .controller('biologicalSamplesController', ['$scope', '$http', '$state', function($scope, $http, $state) {
        ...
        $scope.save = function() {
            ...
            mlBiologicalSamples.num1quantity = $scope.num1quantity;
            mlBiologicalSamples.num2quantity = $scope.num2quantity;
            mlBiologicalSamples.num3quantity = $scope.num3quantity;
            mlBiologicalSamples.num4quantity = $scope.num4quantity;
            mlBiologicalSamples.num5quantity = $scope.num5quantity;
            mlBiologicalSamples.num6quantity = $scope.num6quantity;
