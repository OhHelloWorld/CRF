 ...
 */
@Entity(name = "ml_four")
public class MedicineLiverFourDO {
    ...
    @Column(name = "tongue_nature_part")
    private int tongueNaturePart;//舌质部分
    private int tongueBody;//舌体
    private int mossNature;//苔质
    @Column(name = "moss_nature_part")
    private int mossNaturePart;//苔质部分
    private int mossColor;//苔色
    @Column(name = "moss_color_part")
    private int mossColorPart;//苔色部分
    private int sublingualVein;//舌下静脉
    private int leftVein;//左脉
    private int rightVein;//右脉
    private int fatigue;//乏力
    private int skinItching;//皮肤瘙痒
    @Column(name = "two_eyes_dry")
    ...
    public void setTongueGloss(int tongueGloss) {
        this.tongueGloss = tongueGloss;
    }

    public int getTongueColor() {
        return tongueColor;
    }

    public void setTongueColor(int tongueColor) {
        this.tongueColor = tongueColor;
    }

    public int getTongueNature() {
        return tongueNature;
    }

    public void setTongueNature(int tongueNature) {
        this.tongueNature = tongueNature;
    }

    public int getTongueNaturePart() {
        return tongueNaturePart;
    }

    public void setTongueNaturePart(int tongueNaturePart) {
        this.tongueNaturePart = tongueNaturePart;
    }

    public int getTongueBody() {
        return tongueBody;
    }

    public void setTongueBody(int tongueBody) {
        this.tongueBody = tongueBody;
    }

    public int getMossNature() {
        return mossNature;
    }

    public void setMossNature(int mossNature) {
        this.mossNature = mossNature;
    }

    public int getMossNaturePart() {
        return mossNaturePart;
    }

    public void setMossNaturePart(int mossNaturePart) {
        this.mossNaturePart = mossNaturePart;
    }

    public int getMossColor() {
        return mossColor;
    }

    public void setMossColor(int mossColor) {
        this.mossColor = mossColor;
    }

    public int getMossColorPart() {
        return mossColorPart;
    }

    public void setMossColorPart(int mossColorPart) {
        this.mossColorPart = mossColorPart;
    }

    public int getSublingualVein() {
        return sublingualVein;
    }

    public void setSublingualVein(int sublingualVein) {
        this.sublingualVein = sublingualVein;
    }

    public int getLeftVein() {
        return leftVein;
    }

    public void setLeftVein(int leftVein) {
        this.leftVein = leftVein;
    }

    public int getRightVein() {
        return rightVein;
    }

    public void setRightVein(int rightVein) {
        this.rightVein = rightVein;
    }
    ...
    public int getFlankPain() {
        return flankPain;
    }

    public void setFlankPain(int flankPain) {
        this.flankPain = flankPain;
    }

    public int getFlankPainPersist() {
        return flankPainPersist;
    }

    public void setFlankPainPersist(int flankPainPersist) {
        this.flankPainPersist = flankPainPersist;
    }
    ...
    public int getSweatPersist() {
        return sweatPersist;
    }

    public void setSweatPersist(int sweatPersist) {
        this.sweatPersist = sweatPersist;
    }
