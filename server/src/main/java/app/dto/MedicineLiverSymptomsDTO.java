...
public class MedicineLiverSymptomsDTO {
    ...
    private Date anorexiaBeginDate;//纳差出现时间
    ...
    private Date liverPainBeginDate;//肝区疼痛出现时间
    ...
    public Date getEpistaxisBeginDate() {
        return epistaxisBeginDate;
    }

    public void setEpistaxisBeginDate(Date epistaxisBeginDate) {
        this.epistaxisBeginDate = epistaxisBeginDate;
    }
    ...
    public Date getAnorexiaBeginDate() {
        return anorexiaBeginDate;
    }

    public void setAnorexiaBeginDate(Date anorexiaBeginDate) {
        this.anorexiaBeginDate = anorexiaBeginDate;
    }

    public Date getLiverPainBeginDate() {
        return liverPainBeginDate;
    }

    public void setLiverPainBeginDate(Date liverPainBeginDate) {
    ...
    public Date getRashDisappearDate() {
        return rashDisappearDate;
    }

    public void setRashDisappearDate(Date rashDisappearDate) {
        this.rashDisappearDate = rashDisappearDate;
    }
    ...
    public List<MedicineLiverSymptomsOtherDTO> getMedicineLiverSymptomsOtherDTOs() {
        return medicineLiverSymptomsOtherDTOs;
    }

    public void setMedicineLiverSymptomsOtherDTOs(List<MedicineLiverSymptomsOtherDTO> medicineLiverSymptomsOtherDTOs) {
        this.medicineLiverSymptomsOtherDTOs = medicineLiverSymptomsOtherDTOs;
    }
}
