 ...
 */
@Component
public class MlCreateAllExcel implements CreateAllExcelInterface {
    ...
    public void createAllExcel() throws Exception {
        ...
        for (int i = 0; i < mlPatientDOs.size(); i++) {
            ...
            if(mlDrinkDO != null){
                ...
                row.createCell(22).setCellValue(mlDrinkDetail.toString());
            }
            ...
            if(mlDrugDO != null){
                ...
                row.createCell(23).setCellValue(drug.toString());
            }

            //症状体征
            if(mlSymptomsDO != null){

                row.createCell(24).setCellValue(mlSymptomsDO.getLiverInjury()==1?"否":(mlSymptomsDO.getLiverInjury()==2?"有":(mlSymptomsDO.getLiverInjury()==3?"不详":"")));
                //乏力
                row.createCell(25).setCellValue(mlSymptomsDO.getWeak()==1?"轻度":(mlSymptomsDO.getWeak()==2?"中度":(mlSymptomsDO.getWeak()==3?"重度":(mlSymptomsDO.getWeak()==4?"不详":""))));
                row.createCell(26).setCellValue(mlSymptomsDO.getWeakBeginDate());
                row.createCell(27).setCellValue(mlSymptomsDO.getWeakDisappearDate());
                row.createCell(28).setCellValue(mlSymptomsDO.getWeakDischarge()==1?"轻度":(mlSymptomsDO.getWeakDischarge()==2?"中度":(mlSymptomsDO.getWeakDischarge()==3?"重度":(mlSymptomsDO.getWeakDischarge()==4?"不详":""))));

                //纳差
                row.createCell(29).setCellValue(mlSymptomsDO.getAnorexia()==1?"轻度":(mlSymptomsDO.getAnorexia()==2?"中度":(mlSymptomsDO.getAnorexia()==3?"重度":(mlSymptomsDO.getAnorexia()==4?"不详":""))));
                row.createCell(30).setCellValue(mlSymptomsDO.getAnorexiaBeginDate());
                row.createCell(31).setCellValue(mlSymptomsDO.getAnorexiaDisappearDate());
                row.createCell(32).setCellValue(mlSymptomsDO.getAnorexiaDischarge()==1?"轻度":(mlSymptomsDO.getAnorexiaDischarge()==2?"中度":(mlSymptomsDO.getAnorexiaDischarge()==3?"重度":(mlSymptomsDO.getAnorexiaDischarge()==4?"不详":""))));

                //腹胀
                row.createCell(33).setCellValue(mlSymptomsDO.getAbdominalDistention()==1?"轻度":(mlSymptomsDO.getAbdominalDistention()==2?"中度":(mlSymptomsDO.getAbdominalDistention()==3?"重度":(mlSymptomsDO.getAbdominalDistention()==4?"不详":""))));
                row.createCell(34).setCellValue(mlSymptomsDO.getAbdominalDistentionBeginDate());
                row.createCell(35).setCellValue(mlSymptomsDO.getAbdominalDistentionDisappearDate());
                row.createCell(36).setCellValue(mlSymptomsDO.getAbdominalDistentionDischarge()==1?"轻度":(mlSymptomsDO.getAbdominalDistentionDischarge()==2?"中度":(mlSymptomsDO.getAbdominalDistentionDischarge()==3?"重度":(mlSymptomsDO.getAbdominalDistentionDischarge()==4?"不详":""))));

                //黄疸
                row.createCell(37).setCellValue(mlSymptomsDO.getJaundice()==1?"轻度":(mlSymptomsDO.getJaundice()==2?"中度":(mlSymptomsDO.getJaundice()==3?"重度":(mlSymptomsDO.getJaundice()==4?"不详":""))));
                row.createCell(38).setCellValue(mlSymptomsDO.getJaundiceBeginDate());
                row.createCell(39).setCellValue(mlSymptomsDO.getJaundiceDisappearDate());
                row.createCell(40).setCellValue(mlSymptomsDO.getJaundiceDischarge()==1?"轻度":(mlSymptomsDO.getAbdominalDistentionDischarge()==2?"中度":(mlSymptomsDO.getAbdominalDistentionDischarge()==3?"重度":(mlSymptomsDO.getAbdominalDistentionDischarge()==4?"不详":""))));

                //恶心
                row.createCell(41).setCellValue(mlSymptomsDO.getNausea()==1?"轻度":(mlSymptomsDO.getNausea()==2?"中度":(mlSymptomsDO.getNausea()==3?"重度":(mlSymptomsDO.getNausea()==4?"不详":""))));
                row.createCell(42).setCellValue(mlSymptomsDO.getNauseaBeginDate());
                row.createCell(43).setCellValue(mlSymptomsDO.getNauseaDisappearDate());
                row.createCell(44).setCellValue(mlSymptomsDO.getNauseaDischarge()==1?"轻度":(mlSymptomsDO.getNauseaDischarge()==2?"中度":(mlSymptomsDO.getNauseaDischarge()==3?"重度":(mlSymptomsDO.getNauseaDischarge()==4?"不详":""))));

                //呕吐
                row.createCell(45).setCellValue(mlSymptomsDO.getVomit()==1?"轻度":(mlSymptomsDO.getVomit()==2?"中度":(mlSymptomsDO.getVomit()==3?"重度":(mlSymptomsDO.getVomit()==4?"不详":""))));
                row.createCell(46).setCellValue(mlSymptomsDO.getVomitBeginDate());
                row.createCell(47).setCellValue(mlSymptomsDO.getVomitDisappearDate());
                row.createCell(48).setCellValue(mlSymptomsDO.getVomitDischarge()==1?"轻度":(mlSymptomsDO.getVomitDischarge()==2?"中度":(mlSymptomsDO.getVomitDischarge()==3?"重度":(mlSymptomsDO.getVomitDischarge()==4?"不详":""))));

                //齿龈出血
                row.createCell(49).setCellValue(mlSymptomsDO.getGingivalBleeding()==1?"轻度":(mlSymptomsDO.getGingivalBleeding()==2?"中度":(mlSymptomsDO.getGingivalBleeding()==3?"重度":(mlSymptomsDO.getGingivalBleeding()==4?"不详":""))));
                row.createCell(50).setCellValue(mlSymptomsDO.getGingivalBleedingBeginDate());
                row.createCell(51).setCellValue(mlSymptomsDO.getGingivalBleedingDisappearDate());
                row.createCell(52).setCellValue(mlSymptomsDO.getGingivalBleedingDischarge()==1?"轻度":(mlSymptomsDO.getGingivalBleedingDischarge()==2?"中度":(mlSymptomsDO.getGingivalBleedingDischarge()==3?"重度":(mlSymptomsDO.getGingivalBleedingDischarge()==4?"不详":""))));

                //鼻衄
                row.createCell(53).setCellValue(mlSymptomsDO.getEpistaxis()==1?"轻度":(mlSymptomsDO.getEpistaxis()==2?"中度":(mlSymptomsDO.getEpistaxis()==3?"重度":(mlSymptomsDO.getEpistaxis()==4?"不详":""))));
                row.createCell(54).setCellValue(mlSymptomsDO.getEpistaxisBeginDate());
                row.createCell(55).setCellValue(mlSymptomsDO.getEpistaxisDisappearDate());
                row.createCell(56).setCellValue(mlSymptomsDO.getEpistaxisDischarge()==1?"轻度":(mlSymptomsDO.getEpistaxisDischarge()==2?"中度":(mlSymptomsDO.getEpistaxisDischarge()==3?"重度":(mlSymptomsDO.getEpistaxisDischarge()==4?"不详":""))));

                //肝区疼痛
                row.createCell(57).setCellValue(mlSymptomsDO.getLiverPain()==1?"轻度":(mlSymptomsDO.getLiverPain()==2?"中度":(mlSymptomsDO.getLiverPain()==3?"重度":(mlSymptomsDO.getLiverPain()==4?"不详":""))));
                row.createCell(58).setCellValue(mlSymptomsDO.getLiverPainBeginDate());
                row.createCell(59).setCellValue(mlSymptomsDO.getLiverPainDisappearDate());
                row.createCell(60).setCellValue(mlSymptomsDO.getLiverPainDischarge()==1?"轻度":(mlSymptomsDO.getLiverPainDischarge()==2?"中度":(mlSymptomsDO.getLiverPainDischarge()==3?"重度":(mlSymptomsDO.getLiverPainDischarge()==4?"不详":""))));

                //肝肿大
                row.createCell(61).setCellValue(mlSymptomsDO.getHepatomegaly()==1?"轻度":(mlSymptomsDO.getHepatomegaly()==2?"中度":(mlSymptomsDO.getHepatomegaly()==3?"重度":(mlSymptomsDO.getHepatomegaly()==4?"不详":""))));
                row.createCell(62).setCellValue(mlSymptomsDO.getHepatomegalyBeginDate());
                row.createCell(63).setCellValue(mlSymptomsDO.getHepatomegalyDisappearDate());
                row.createCell(64).setCellValue(mlSymptomsDO.getHepatomegalyDischarge()==1?"轻度":(mlSymptomsDO.getHepatomegalyDischarge()==2?"中度":(mlSymptomsDO.getHepatomegalyDischarge()==3?"重度":(mlSymptomsDO.getHepatomegalyDischarge()==4?"不详":""))));

                //脾肿大
                row.createCell(65).setCellValue(mlSymptomsDO.getSplenomegaly()==1?"轻度":(mlSymptomsDO.getSplenomegaly()==2?"中度":(mlSymptomsDO.getSplenomegaly()==3?"重度":(mlSymptomsDO.getSplenomegaly()==4?"不详":""))));
                row.createCell(66).setCellValue(mlSymptomsDO.getSplenomegalyBeginDate());
                row.createCell(67).setCellValue(mlSymptomsDO.getSplenomegalyDisappearDate());
                row.createCell(68).setCellValue(mlSymptomsDO.getSplenomegalyDischarge()==1?"轻度":(mlSymptomsDO.getSplenomegalyDischarge()==2?"中度":(mlSymptomsDO.getSplenomegalyDischarge()==3?"重度":(mlSymptomsDO.getSplenomegalyDischarge()==4?"不详":""))));

                //发热
                row.createCell(69).setCellValue(mlSymptomsDO.getFever()==1?"轻度":(mlSymptomsDO.getFever()==2?"中度":(mlSymptomsDO.getFever()==3?"重度":(mlSymptomsDO.getFever()==4?"不详":""))));
                row.createCell(70).setCellValue(mlSymptomsDO.getFeverBeginDate());
                row.createCell(71).setCellValue(mlSymptomsDO.getFeverDisappearDate());
                row.createCell(72).setCellValue(mlSymptomsDO.getFeverDischarge()==1?"轻度":(mlSymptomsDO.getFeverDischarge()==2?"中度":(mlSymptomsDO.getFeverDischarge()==3?"重度":(mlSymptomsDO.getFeverDischarge()==4?"不详":""))));

                //皮疹
                row.createCell(73).setCellValue(mlSymptomsDO.getRash()==1?"轻度":(mlSymptomsDO.getRash()==2?"中度":(mlSymptomsDO.getRash()==3?"重度":(mlSymptomsDO.getRash()==4?"不详":""))));
                row.createCell(74).setCellValue(mlSymptomsDO.getRashBeginDate());
                row.createCell(75).setCellValue(mlSymptomsDO.getRashDisappearDate());
                row.createCell(76).setCellValue(mlSymptomsDO.getRashDischarge()==1?"轻度":(mlSymptomsDO.getRashDischarge()==2?"中度":(mlSymptomsDO.getRashDischarge()==3?"重度":(mlSymptomsDO.getRashDischarge()==4?"不详":""))));

                //关节痛
                row.createCell(77).setCellValue(mlSymptomsDO.getArthralgia()==1?"轻度":(mlSymptomsDO.getArthralgia()==2?"中度":(mlSymptomsDO.getArthralgia()==3?"重度":(mlSymptomsDO.getArthralgia()==4?"不详":""))));
                row.createCell(78).setCellValue(mlSymptomsDO.getArthralgiaBeginDate());
                row.createCell(79).setCellValue(mlSymptomsDO.getArthralgiaDisappearDate());
                row.createCell(80).setCellValue(mlSymptomsDO.getArthralgiaDischarge()==1?"轻度":(mlSymptomsDO.getArthralgiaDischarge()==2?"中度":(mlSymptomsDO.getArthralgiaDischarge()==3?"重度":(mlSymptomsDO.getArthralgiaDischarge()==4?"不详":""))));

                //皮肤瘙痒
                row.createCell(81).setCellValue(mlSymptomsDO.getSkinItch()==1?"轻度":(mlSymptomsDO.getSkinItch()==2?"中度":(mlSymptomsDO.getSkinItch()==3?"重度":(mlSymptomsDO.getSkinItch()==4?"不详":""))));
                row.createCell(82).setCellValue(mlSymptomsDO.getSkinItchBeginDate());
                row.createCell(83).setCellValue(mlSymptomsDO.getSkinItchDisappearDate());
                row.createCell(84).setCellValue(mlSymptomsDO.getSkinItchDischarge()==1?"轻度":(mlSymptomsDO.getSkinItchDischarge()==2?"中度":(mlSymptomsDO.getSkinItchDischarge()==3?"重度":(mlSymptomsDO.getSkinItchDischarge()==4?"不详":""))));
                ...
                row.createCell(85).setCellValue(mlSymptomsOther.toString());
            }

            if(mlFirstDO != null){

                row.createCell(86).setCellValue(mlFirstDO.getAlt());
                row.createCell(87).setCellValue(mlFirstDO.getAst());
                row.createCell(88).setCellValue(mlFirstDO.getGgt());
                row.createCell(89).setCellValue(mlFirstDO.getAlp());
                row.createCell(90).setCellValue(mlFirstDO.getBileAcid());
                row.createCell(91).setCellValue(mlFirstDO.getTbil());
                row.createCell(92).setCellValue(mlFirstDO.getDbil());
                row.createCell(93).setCellValue(mlFirstDO.getTp());
                row.createCell(94).setCellValue(mlFirstDO.getAlb());
                row.createCell(95).setCellValue(mlFirstDO.getScr());
                row.createCell(96).setCellValue(mlFirstDO.getBun());
                row.createCell(97).setCellValue(mlFirstDO.getPlasmaGlucose());
                row.createCell(98).setCellValue(mlFirstDO.getPt());
                row.createCell(99).setCellValue(mlFirstDO.getInr());
                row.createCell(100).setCellValue(mlFirstDO.getAfp());
            }

            if(mlHospitalDO != null){
                row.createCell(101).setCellValue(mlFirstDO.getAlt());
                row.createCell(102).setCellValue(mlFirstDO.getAst());
                row.createCell(103).setCellValue(mlFirstDO.getGgt());
                row.createCell(104).setCellValue(mlFirstDO.getAlp());
                row.createCell(105).setCellValue(mlFirstDO.getBileAcid());
                row.createCell(106).setCellValue(mlFirstDO.getTbil());
                row.createCell(107).setCellValue(mlFirstDO.getDbil());
                row.createCell(108).setCellValue(mlFirstDO.getTp());
                row.createCell(109).setCellValue(mlFirstDO.getAlb());
                row.createCell(110).setCellValue(mlFirstDO.getScr());
                row.createCell(111).setCellValue(mlFirstDO.getBun());
                row.createCell(112).setCellValue(mlFirstDO.getPlasmaGlucose());
                row.createCell(113).setCellValue(mlFirstDO.getPt());
                row.createCell(114).setCellValue(mlFirstDO.getInr());
                row.createCell(115).setCellValue(mlFirstDO.getAfp());
            }

            if(mlExcludeDO != null){
                row.createCell(116).setCellValue(mlExcludeDO.getAntiHav());
                row.createCell(117).setCellValue(mlExcludeDO.getHbvdna());
                row.createCell(118).setCellValue(mlExcludeDO.getAntihcv());
                row.createCell(119).setCellValue(mlExcludeDO.getHcvrna());
                row.createCell(120).setCellValue(mlExcludeDO.getMononucleosis());
                row.createCell(121).setCellValue(mlExcludeDO.getRheumatoid());
                row.createCell(122).setCellValue(mlExcludeDO.getCeruloplasmin());
                row.createCell(123).setCellValue(mlExcludeDO.getHbsag());
                row.createCell(124).setCellValue(mlExcludeDO.getHbsab());
                row.createCell(125).setCellValue(mlExcludeDO.getHbcab());
                row.createCell(126).setCellValue(mlExcludeDO.getHbeag());
                row.createCell(127).setCellValue(mlExcludeDO.getHbeab());
                row.createCell(128).setCellValue(mlExcludeDO.getAna());
                row.createCell(129).setCellValue(mlExcludeDO.getAma());
                row.createCell(130).setCellValue(mlExcludeDO.getAmam2());
                row.createCell(131).setCellValue(mlExcludeDO.getSma());
                row.createCell(132).setCellValue(mlExcludeDO.getLkm());
                row.createCell(133).setCellValue(mlExcludeDO.getCytomegalovirus());
                row.createCell(134).setCellValue(mlExcludeDO.getEbviruses());
                row.createCell(135).setCellValue(mlExcludeDO.getHerpesSimplex());
            }

            if(mlBloodDO != null){
                row.createCell(136).setCellValue(mlBloodDO.getWbc());
                row.createCell(137).setCellValue(mlBloodDO.getHb());
                row.createCell(138).setCellValue(mlBloodDO.getTotalHemoglobin());
                row.createCell(139).setCellValue(mlBloodDO.getPlt());
                row.createCell(140).setCellValue(mlBloodDO.getNeutrophil());
                row.createCell(141).setCellValue(mlBloodDO.getEosinophil());
            }

            if(mlImagingDO != null){
                row.createCell(142).setCellValue(mlImagingDO.getLiverBultrasound());
                row.createCell(143).setCellValue(mlImagingDO.getLiverBultrasoundBiliaryTract());
                row.createCell(144).setCellValue(mlImagingDO.getLiverBultrasoundEsophagealGastricVarices());
                row.createCell(145).setCellValue(mlImagingDO.getLiverCt());
                row.createCell(146).setCellValue(mlImagingDO.getLiverCtBiliaryTract());
                row.createCell(147).setCellValue(mlImagingDO.getLiverCtEsophagealGastricVarices());
                row.createCell(148).setCellValue(mlImagingDO.getLiverMri());
                row.createCell(149).setCellValue(mlImagingDO.getLiverMriBiliaryTract());
                row.createCell(150).setCellValue(mlImagingDO.getLiverMriEsophagealGastricVarices());
                row.createCell(151).setCellValue(mlImagingDO.getLiverMriEsophagealGastricVarices());
                row.createCell(152).setCellValue(mlImagingDO.getLiverMriEsophagealGastricVarices());
                row.createCell(153).setCellValue(mlImagingDO.getFibroscan());
                row.createCell(154).setCellValue(mlImagingDO.getFibroscanBiliaryTract());
                row.createCell(155).setCellValue(mlImagingDO.getFibroscanEsophagealGastricVarices());
                row.createCell(156).setCellValue(mlImagingDO.getErcp());
                row.createCell(157).setCellValue(mlImagingDO.getErcpBiliaryTract());
                row.createCell(158).setCellValue(mlImagingDO.getErcpEsophagealGastricVarices());
                row.createCell(159).setCellValue(mlImagingDO.getMrcp());
                row.createCell(160).setCellValue(mlImagingDO.getMrcpBiliaryTract());
                row.createCell(161).setCellValue(mlImagingDO.getMrcpEsophagealGastricVarices());
                row.createCell(162).setCellValue(mlImagingDO.getGastroscope());
                row.createCell(163).setCellValue(mlImagingDO.getGastroscopeBiliaryTract());
                row.createCell(164).setCellValue(mlImagingDO.getGastroscopeEsophagealGastricVarices());
            }

            if(mlHistologicalDO != null){
                row.createCell(165).setCellValue(mlHistologicalDO.getLiverHistologicalResult());
            }

            if(mlInjuryDO != null){
                row.createCell(166).setCellValue(mlInjuryDO.getAscites());
            }
